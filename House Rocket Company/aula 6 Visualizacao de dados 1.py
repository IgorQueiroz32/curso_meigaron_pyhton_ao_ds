...
#1. recapitulando
#2. Requisicao do CEO
#3. planejamento do Dashboard
#4. Criacao de Dashboards Web
#5. Exercicios
...
#2.1 Gostaria de chegar de manha na minha mesa e ter um lugar unico onde eu possa observar o portifolio da
...
# Dashboard - conjunto de dados (conjunto de graficos)
